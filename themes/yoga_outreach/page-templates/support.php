	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
            <header class="entry-header custom-hero-image">
                ...
                <div>
                    <button class="button-holder">Donate</button>
                    <button class="button-holder">Become Event Sponsor</button>
                    <button class="button-holder">Shop T-Shirt</button>
                    <button class="button-holder">Current Sponsor</button>
                </div>
            </header><!-- .entry-header -->
            ...
            <section class="container-tshirt">
